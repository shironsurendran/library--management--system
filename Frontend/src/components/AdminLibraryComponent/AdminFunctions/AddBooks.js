...
export class AddBooks extends Component {
    ...
    onSubmitHandeler = (event) =>{
        ...
        if(this.state.bookName === '' || this.state.authorName==='' || this.state.publisher==='' || this.state.language==='' ||
          this.state.description==='' || this.state.price==='' || this.state.ISBN==='' || this.state.imageForMulter==='' ){
            ...
            bookData.append('ISBN', this.state.ISBN)
                ...
                <div className="row">
                    <div className="col-8 formTop"  >
                        <form onSubmit={this.onSubmitHandeler}> 
                            ...
                            <div className="form-group">
                                <label>ISBN</label>
                                <input type="number" className="form-control" onChange={this.isbnHandeler}></input>
                            </div>
